diff --git a/insta-phone-SAAS-sneder/app/planner_service.py b/insta-phone-SAAS-sneder/app/planner_service.py
index 9d1ace9..d6119f1 100644
--- a/insta-phone-SAAS-sneder/app/planner_service.py
+++ b/insta-phone-SAAS-sneder/app/planner_service.py
@@ -6,7 +6,7 @@ and warmup service functions.
 """
 import json
 import logging
...
+from datetime import date, datetime
 ...
 from . import db
@@ -182,12 +182,17 @@ def generate_weekly_plan(proxy_id, week_date=None):
         db.session.add(new_plan)
 
     # Write personality state back to DB
+    # Must deepcopy: _get_accounts_for_proxy returns the same dict object
...
+                flag_modified(ba, "personality_json")
     ...
     db.session.commit()
     return plan_dict
diff --git a/insta-phone-SAAS-sneder/tests/test_planner_service.py b/insta-phone-SAAS-sneder/tests/test_planner_service.py
new file mode 100644
index 0000000..37ab3cd
--- /dev/null
+++ b/insta-phone-SAAS-sneder/tests/test_planner_service.py
@@ -0,0 +1,484 @@
