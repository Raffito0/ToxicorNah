...
Generate content for section `section-03-planner-service` (filename: `section-03-planner-service.md`).
...
for `section-03-planner-service` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\04-unified-planner-warmup/sections/section-03-planner-service.md`
