...
Generate content for section `section-04-api-routes` (filename: `section-04-api-routes.md`).
...
for `section-04-api-routes` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\04-unified-planner-warmup/sections/section-04-api-routes.md`
