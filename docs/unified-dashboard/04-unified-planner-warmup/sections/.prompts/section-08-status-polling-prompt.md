...
Generate content for section `section-08-status-polling` (filename: `section-08-status-polling.md`).
...
for `section-08-status-polling` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\04-unified-planner-warmup/sections/section-08-status-polling.md`
