...
Generate content for section `section-02-personality-frontend` (filename: `section-02-personality-frontend.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\05-personality-timing-niche/claude-plan.md` - Full implementation plan
2. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\05-personality-timing-niche/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\05-personality-timing-niche/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-personality-frontend` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\05-personality-timing-niche/sections/section-02-personality-frontend.md`
