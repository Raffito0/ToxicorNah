...
Generate content for section `section-05-niche-config` (filename: `section-05-niche-config.md`).
...
for `section-05-niche-config` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\docs\unified-dashboard\05-personality-timing-niche/sections/section-05-niche-config.md`
