...
Generate content for section `section-02-pymk-carousel` (filename: `section-02-pymk-carousel.md`).
...
for `section-02-pymk-carousel` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-02-pymk-carousel.md`
