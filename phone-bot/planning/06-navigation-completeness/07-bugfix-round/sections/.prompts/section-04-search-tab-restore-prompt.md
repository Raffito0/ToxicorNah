...
Generate content for section `section-04-search-tab-restore` (filename: `section-04-search-tab-restore.md`).
...
for `section-04-search-tab-restore` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-04-search-tab-restore.md`
