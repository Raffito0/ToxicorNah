...
Generate content for section `section-05-tap-to-exit-toast` (filename: `section-05-tap-to-exit-toast.md`).
...
for `section-05-tap-to-exit-toast` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-05-tap-to-exit-toast.md`
