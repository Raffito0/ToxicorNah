...
Generate content for section `section-06-live-double-scroll` (filename: `section-06-live-double-scroll.md`).
...
for `section-06-live-double-scroll` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-06-live-double-scroll.md`
