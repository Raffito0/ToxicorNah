...
Generate content for section `section-07-retype-test` (filename: `section-07-retype-test.md`).
...
for `section-07-retype-test` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-07-retype-test.md`
