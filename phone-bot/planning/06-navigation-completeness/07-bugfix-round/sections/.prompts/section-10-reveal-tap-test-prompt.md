...
Generate content for section `section-10-reveal-tap-test` (filename: `section-10-reveal-tap-test.md`).
...
for `section-10-reveal-tap-test` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-10-reveal-tap-test.md`
