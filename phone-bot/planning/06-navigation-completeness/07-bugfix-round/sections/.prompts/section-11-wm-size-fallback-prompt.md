...
Generate content for section `section-11-wm-size-fallback` (filename: `section-11-wm-size-fallback.md`).
...
for `section-11-wm-size-fallback` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-11-wm-size-fallback.md`
