...
Generate content for section `section-13-story-follow-verify` (filename: `section-13-story-follow-verify.md`).
...
for `section-13-story-follow-verify` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\06-navigation-completeness\07-bugfix-round/sections/section-13-story-follow-verify.md`
