...
Generate content for section `section-01-env-config` (filename: `section-01-env-config.md`).
...
for `section-01-env-config` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-01-env-config.md`
