...
Generate content for section `section-02-cross-platform` (filename: `section-02-cross-platform.md`).
...
for `section-02-cross-platform` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-02-cross-platform.md`
