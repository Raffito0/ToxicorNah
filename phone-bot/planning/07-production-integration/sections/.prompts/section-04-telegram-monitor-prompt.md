...
Generate content for section `section-04-telegram-monitor` (filename: `section-04-telegram-monitor.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/claude-plan.md` - Full implementation plan
2. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-telegram-monitor` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-04-telegram-monitor.md`
