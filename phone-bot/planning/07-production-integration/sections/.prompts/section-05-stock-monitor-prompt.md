...
Generate content for section `section-05-stock-monitor` (filename: `section-05-stock-monitor.md`).
...
for `section-05-stock-monitor` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-05-stock-monitor.md`
