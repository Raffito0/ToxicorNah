...
Generate content for section `section-06-always-on` (filename: `section-06-always-on.md`).
...
for `section-06-always-on` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-06-always-on.md`
