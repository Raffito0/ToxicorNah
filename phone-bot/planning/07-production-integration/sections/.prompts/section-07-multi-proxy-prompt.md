...
Generate content for section `section-07-multi-proxy` (filename: `section-07-multi-proxy.md`).
...
for `section-07-multi-proxy` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-07-multi-proxy.md`
