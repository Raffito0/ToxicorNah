...
Generate content for section `section-08-e2e-test` (filename: `section-08-e2e-test.md`).
...
for `section-08-e2e-test` to understand what this section should contain.
...
`C:\Users\rafca\OneDrive\Desktop\Toxic or Nah\phone-bot\planning\07-production-integration/sections/section-08-e2e-test.md`
