    ...
    const mockConnections = [
      {
        ...
        currentScore: 70,
        scoreDelta: 5,
        archetypeTitle: 'The Ice Charmer',
        archetypeImage: `${import.meta.env.VITE_SUPABASE_URL || ''}/storage/v1/object/public/dynamic-archetypes/soul-types/male/${encodeURIComponent('The Ice Charmer-side.png')}`,
      ...
      },
      {
        ...
        archetypeImage: `${import.meta.env.VITE_SUPABASE_URL || ''}/storage/v1/object/public/dynamic-archetypes/soul-types/male/${encodeURIComponent('The Ghost-side.png')}`,
