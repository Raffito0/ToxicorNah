  ...
  if (isDev) {
    return {
      ...
      archetype: {
        ...
        description: "He's trying to charm you but it's coming off as creepy and aggressive. Not the energy you want.",
        ...
        traits: ["Love bomber", "Intensity overload", "Surface charm"],
        gradientFrom: "#3b82f6",
        gradientTo: "#1e3a5f",
      ...
      mirror: {
        ...
        personArchetypeTitle: "The Sweet Poison",
        personArchetypeImage: getMaleSoulTypeByName('The Sweet Poison')?.normalImage || '',
        personArchetypeSideImage: getMaleSoulTypeByName('The Sweet Poison')?.sideProfileImage || '',
        personName: "Alex",
        powerBalance: 65,
